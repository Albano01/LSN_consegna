...
public:
  ...
  // Method to generate a random number with a exponential distribution (FATTO DA ME PER QUESTO ESERCIZIO)
  double Exp(double mean);
  // Method to generate a random number with a Cauchy-Lorentz distribution (FATTO DA ME PER QUESTO ESERCIZIO)
