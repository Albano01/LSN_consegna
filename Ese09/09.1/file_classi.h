...
class Popolazione : public Cromosoma, public Territorio{
 ...
 public:
  ...
  void Stampa_Lungh(){                                          //Metodo che quando chiamato stampa della popolazione corrente la lunghezza del miglior cromosoma e la media delle lunghezze della metà migliore di cromosomi
