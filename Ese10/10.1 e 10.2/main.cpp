...
int main(int argc, char* argv[]){
  ...
  MPI_Comm_rank(MPI_COMM_WORLD, &rank);     //Dice ai processi che rank sono [0,...,size-1]
  ...
  MPI_Gather(send_bestpath.data(), N_Citta, MPI_INT,   //mando tutti i migliori cammini nel rank 0
